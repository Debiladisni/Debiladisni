      ...
      <div className="bg-black p-8 rounded-lg shadow-lg w-full max-w-md">
        ...
        <form>
          <div className="mb-4">
            ...
            <input className="w-full text-red-500 px-3 py-2 border border-gray-300 rounded-lg" type="text" id="name" placeholder="Name" />
          </div>
          <div className="mb-4">
          ...
          <Link to ="/Home">
          <button className="w-full bg-red-400 text-white py-2 rounded-lg hover:bg-red-700 transition duration-300" type="submit">Sign Up</button>
          </Link>
        </form>
        <div className="mt-4 text-center">
          <Link to="/login" className="text-white-500 hover:underline">Already have an account? Login</Link>
        </div>
      </div>
      </div>
      </div>
